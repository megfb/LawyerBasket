...
namespace LawyerBasket.PostService.Application.CommandHandlers
{
  public class CreateCommentCommandHandler : IRequestHandler<CreateCommentCommand, ApiResult<CommentDto>>
  {
    ...
    public CreateCommentCommandHandler(ICurrentUserService currentUserService,IMapper mapper, IMediator mediator, IUnitOfWork unitOfWork, IPostRepository postRepository, ILogger<CreateCommentCommandHandler> logger)
    {
