...
@Component({
  selector: 'app-commented-posts-list',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './commented-posts-list.component.html',
  styleUrl: './commented-posts-list.component.css'
})
export class CommentedPostsListComponent implements OnInit {
